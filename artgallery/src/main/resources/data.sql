...
VALUES
('빛으로 그린 이야기', 'POSTER_IMG', '이 전시회는 다양한 빛의 표현을 통해 인간 내면의 감정을 그려냅니다. 자연광, 인공조명, 그림자 등 다양한 요소가 어우러져 시각적으로 풍부한 경험을 선사합니다.', '2024-04-01', '2024-08-31', 10000),
('감정의 파동', 'POSTER_IMG', '감정이라는 추상적인 개념을 색채와 형태로 시각화한 전시입니다. 작가들은 사랑, 분노, 슬픔, 희망 등을 다양한 매체를 통해 표현하며 관람객에게 깊은 공감을 이끌어냅니다.', '2024-04-01', '2024-08-31', 8000),
('시간의 정원', 'POSTER_IMG', '이 전시는 사계절을 주제로 구성된 공간 속에서 시간이 흐르는 방식과 그 속의 자연 변화를 체험할 수 있도록 설계되었습니다. 각 공간은 계절마다 다른 정서와 색채를 담고 있습니다.', '2024-04-01', '2024-08-31', 12000),
('도시의 단면들', 'POSTER_IMG', '현대 도시의 다양한 모습을 건축, 거리, 인간 군상으로 구성한 다층적 전시입니다. 소외된 공간, 익숙한 거리 풍경이 새로운 시선으로 재해석됩니다.', '2024-04-01', '2024-08-31', 9000),
('기억의 조각들', 'POSTER_IMG', '개인의 기억과 집단의 역사를 시각적으로 엮어낸 전시입니다. 사진, 텍스트, 설치 미술이 어우러져 관람객에게 자신만의 기억을 떠올릴 수 있는 장을 제공합니다.', '2024-04-01', '2024-08-31', 11000),
('몽환과 현실 사이', 'POSTER_IMG', '현실 세계와 상상의 경계에서 태어난 이미지들을 통해 인간의 무의식을 표현하는 전시입니다. 꿈같은 색채와 기묘한 구성은 관람객을 마치 다른 차원으로 이끌어갑니다.', '2024-04-01', '2024-08-31', 9500),
('움직이는 정물화', 'POSTER_IMG', '전통 정물화에 생명을 불어넣은 작품들을 중심으로 구성된 전시입니다. 디지털 기술과 회화의 접목을 통해 기존 회화의 고정관념을 넘어서는 새로운 시도를 엿볼 수 있습니다.', '2024-04-01', '2024-08-31', 10000),
('사라지는 풍경들', 'POSTER_IMG', '개발과 도시화로 점차 사라지는 공간을 기록하고자 하는 의도로 기획된 전시입니다. 회화, 영상, 인터뷰 기록이 함께 어우러져 감성적이면서도 사회적 메시지를 전달합니다.', '2024-04-01', '2024-08-31', 8500),
('소리 없는 이야기', 'POSTER_IMG', '청각적 요소가 배제된 시각적 작품들로만 구성된 전시로, 조용한 공간에서 오직 시각적 감각에 집중할 수 있는 기회를 제공합니다. 침묵 속에서 들려오는 이야기들을 감상해 보세요.', '2024-04-01', '2024-08-31', 10500),
('흑백의 미학', 'POSTER_IMG', '모든 작품이 흑백의 명암만으로 구성된 전시로, 색채 없이 표현되는 세상의 다양한 면모를 보여줍니다. 고요하지만 강렬한 대비가 인상적인 작품들을 만날 수 있습니다.','2024-04-01', '2024-08-31', 9900);
