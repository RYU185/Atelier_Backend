...
VALUES
('봄날의 정원', 'art01.jpg', '따뜻한 봄날의 정원을 그린 작품입니다.', '2023-03-15', '2023-04-01', 1, false),
('도심 속 고요함', 'art02.jpg', '복잡한 도시에서 느껴지는 순간의 평온함.', '2022-11-20', '2022-12-05', 2, false),
('몽환의 숲', 'art03.jpg', '환상적인 분위기의 숲을 묘사한 작품입니다.', '2023-07-10', '2023-07-15', 3, false),
('해질녘 바다', 'art04.jpg', '붉은 노을과 잔잔한 바다를 그렸습니다.', '2021-08-25', '2021-09-01', 4, false),
('달빛 아래 춤', 'art05.jpg', '달빛 아래 인물의 실루엣을 담은 감성적 작품.', '2023-01-01', '2023-01-10', 5, false),
('시간의 흐름', 'art06.jpg', '시계와 그림자를 통해 시간의 흐름을 표현했습니다.', '2022-05-12', '2022-05-18', 6, false),
('고양이의 오후', 'art07.jpg', '햇살 아래 졸고 있는 고양이의 모습을 그렸습니다.', '2024-02-20', '2024-02-25', 7, false),
('하늘을 나는 섬', 'art08.jpg', '공상과학 느낌의 공중 섬을 그린 작품입니다.', '2021-12-01', '2021-12-07', 8, false),
('비 오는 거리', 'art09.jpg', '빗속에서 우산을 든 사람들의 모습이 인상적인 작품.', '2022-09-14', '2022-09-20', 9, false),
('겨울 숲 속 산책', 'art10.jpg', '눈 쌓인 숲길을 걷는 풍경을 그렸습니다.', '2023-12-24', '2023-12-30', 10, false),
('새벽 감성', 'art11.jpg', '새벽녘의 고요한 도시 풍경을 담았습니다.', '2023-06-10', '2023-06-12', 1, false),
('별 헤는 밤', 'art12.jpg', '밤하늘의 별을 바라보며 떠오른 감정들을 표현.', '2023-09-01', '2023-09-03', 2, false),
('황혼의 강가', 'art13.jpg', '강가에서 맞이한 황혼의 장면을 그렸습니다.', '2022-10-11', '2022-10-15', 3, false),
('안개 속 도시', 'art14.jpg', '안개가 자욱한 도시의 미스터리한 느낌을 담았습니다.', '2023-01-25', '2023-01-30', 4, false),
('눈 내리는 밤', 'art15.jpg', '하얗게 덮인 도시 야경을 표현했습니다.', '2022-12-18', '2022-12-20', 5, false),
('가을의 끝자락', 'art16.jpg', '가을이 지나가는 마지막 순간을 그렸습니다.', '2023-11-03', '2023-11-05', 6, false),
('숲속의 비밀', 'art17.jpg', '숲속 깊은 곳에 숨겨진 이야기.', '2023-04-07', '2023-04-09', 7, false),
('빛과 그림자', 'art18.jpg', '빛과 그림자의 대비를 표현한 작품입니다.', '2021-10-10', '2021-10-12', 8, false),
('유리창 너머', 'art19.jpg', '창밖 세상을 바라보는 시선을 그렸습니다.', '2022-02-14', '2022-02-18', 9, false),
('고요한 호수', 'art20.jpg', '잔잔한 호수의 반영과 평온함.', '2022-07-20', '2022-07-25', 10, false),
('하늘의 감정', 'art21.jpg', '구름과 하늘색의 조화로 감정을 표현.', '2023-05-15', '2023-05-18', 1, false),
('노을 속의 약속', 'art22.jpg', '노을 아래의 약속과 그리움을 담았습니다.', '2023-08-08', '2023-08-10', 2, false),
('추억의 거리', 'art23.jpg', '어릴 적 기억을 떠오르게 하는 골목.', '2022-03-13', '2022-03-15', 3, false),
('첫 눈의 설렘', 'art24.jpg', '올해 첫 눈의 감동을 담았습니다.', '2023-11-29', '2023-12-01', 4, false),
('별빛 아래 고백', 'art25.jpg', '밤하늘 별빛 아래의 고백 순간.', '2022-06-06', '2022-06-09', 5, false),
('서점의 오후', 'art26.jpg', '책 향기 가득한 오후의 서점.', '2024-01-05', '2024-01-10', 6, false),
('강아지의 시선', 'art27.jpg', '반려견의 시선에서 본 세상.', '2021-04-01', '2021-04-03', 7, false),
('회상의 골목', 'art28.jpg', '추억이 깃든 골목길.', '2022-08-17', '2022-08-20', 8, false),
('한여름 밤의 꿈', 'art29.jpg', '한여름 밤의 환상적인 장면.', '2023-07-21', '2023-07-25', 9, false),
('비 오는 창가', 'art30.jpg', '창밖을 바라보며 내리는 비를 담았습니다.', '2023-03-03', '2023-03-06', 10, false);




INSERT INTO artist_gallery (title, poster_url, description, start_date, end_date, price, deadline)
VALUES
('환 혼', 'poster1.jpg', '이 전시회는 다양한 빛의 표현을 통해 인간 내면의 감정을 섬세하게 그려냅니다. 자연광과 인공조명, 그림자 등 빛의 요소들이 조화롭게 어우러지며, 관람객은 시각적으로 풍부한 자극을 경험하게 됩니다. 각 작품은 빛을 통해 감정의 흐름과 변화, 그리고 내면의 깊이를 탐구하는 여정을 선사합니다.', '2024-05-01', '2024-05-31', 10000, '2024-05-30'),
('감정의 파동', 'poster2.jpg', '감정이라는 추상적인 개념을 색채와 형태로 시각화한 이 전시는, 사랑, 분노, 슬픔, 희망 등 인간의 다양한 감정을 예술로 풀어냅니다. 작가들은 회화, 조각, 미디어 아트 등 다양한 매체를 활용하여 감정의 에너지를 표현하고, 관람객에게 감정의 진폭과 여운을 깊이 있게 전달하고자 합니다.', '2024-06-15', '2024-07-10', 8000, '2024-07-09'),
('NEW TURN', 'poster3.jpg', '이 전시는 사계절을 주제로 구성된 공간 속에서 시간이 흐르는 방식과 자연의 순환을 체험할 수 있도록 설계되었습니다. 각 계절은 고유한 색감과 정서를 지니며, 그 안에서 느껴지는 시간의 흐름과 감정의 변화는 관람객에게 일상 속에서 놓치기 쉬운 계절의 아름다움을 다시금 일깨워줍니다.', '2025-04-01', '2025-08-30', 12000, '2025-03-31'),
('도시의 단면들', 'poster4.jpg', '현대 도시의 복잡한 양상을 건축물, 거리, 그리고 인간 군상 등을 통해 다층적으로 구성한 전시입니다. 익숙하지만 간과되었던 도시의 풍경과 소외된 공간들을 새로운 시선으로 조명하며, 관람객은 도시가 품고 있는 다양한 삶의 모습과 구조적 이면을 사유하게 됩니다.', '2024-09-10', '2024-10-10', 9000, '2024-10-09'),
('미 로', 'poster5.jpg', '개인의 기억과 집단의 역사를 시각적으로 풀어낸 이 전시는, 과거와 현재, 개인과 사회를 연결하는 매개로서의 예술의 역할을 탐색합니다. 사진, 텍스트, 설치 미술 등이 어우러져 구성된 공간은 관람객 각자의 기억을 되돌아보게 하며, 공감과 회상의 장을 제공합니다.', '2025-11-01', '2025-11-25', 11000, '2025-11-24'),
('몽환과 현실 사이', 'poster6.png', '현실과 꿈의 경계에서 태어난 이 전시는 인간의 무의식을 탐험하며 기묘하고 환상적인 이미지들을 제시합니다. 비현실적인 색채와 구성, 상징적인 오브제들은 현실을 벗어난 차원으로 관람객을 이끌고, 상상과 현실이 혼재된 새로운 감각의 세계를 경험하게 합니다.', '2025-01-05', '2025-01-30', 9500, '2025-01-29'),
('매혹의 언어', 'poster7.jpg', '전통 정물화에 현대적 생명을 불어넣은 이 전시는 회화와 디지털 기술의 결합을 통해 예술의 경계를 확장합니다. 익숙한 오브제가 새로운 시선으로 재구성되며, 정적인 이미지 속에서 움직임과 내면의 메시지를 읽어낼 수 있는 실험적인 시도가 돋보입니다.', '2025-03-10', '2025-06-05', 10000, '2025-06-04'),
('궁금의 질문들', 'poster8.jpg', '개발과 도시화 속에 사라져가는 공간과 기억들을 예술로 기록한 전시입니다. 회화, 영상, 인터뷰 기록이 함께 어우러져 잊혀진 장소의 흔적을 되살리며, 관람객은 자신이 살아온 공간에 대한 새로운 질문과 감정적 울림을 경험할 수 있습니다.', '2025-01-15', '2025-06-10', 8500, '2025-06-09'),
('ART EXHIBITION', 'poster9.png', '청각적 요소가 완전히 배제된 이 전시는 오직 시각적 감각에만 집중할 수 있도록 설계된 전시입니다. 소리 없는 공간에서 시각적 요소만으로 전달되는 감정과 메시지를 탐색하며, 관람객은 침묵 속에 숨겨진 이야기들과 마주하게 됩니다.', '2025-03-01', '2025-05-31', 10500, '2025-05-30'),
('흑백의 미학', 'poster10.jpg', '모든 작품이 흑백의 명암만으로 구성된 이 전시는 색채 없이도 감정을 표현할 수 있는 예술의 가능성을 보여줍니다. 극적인 명암의 대비와 구성은 고요하면서도 강렬한 인상을 남기며, 색의 부재 속에서도 풍부한 감성을 이끌어내는 작품들이 전시됩니다.', '2024-12-01', '2025-02-26', 9900, '2025-02-25');
...
('드로잉 작업실', 'UserPoster1.jpg', 0, '매일 바라보던 창밖 풍경이 이렇게 다채로웠던가요? 시간의 흐름에 따라 변하는 빛과 그림자, 계절의 색감, 그리고 그날의 감정까지 고스란히 담아낸 시선의 기록입니다. 일상의 평범함 속에서 발견한 특별함을 드로잉으로 풀어낸 소박하고 진솔한 전시입니다.', '2025-06-05', '2025-06-12'),
('드로잉 페어링', 'UserPoster2.jpg', 0, '무의식 속에서 떠오른 이미지들을 선과 색으로 풀어낸 이번 전시는, 감정의 파편과 꿈의 조각들이 한데 어우러진 몽환적인 세계를 제시합니다. 작품 하나하나가 내면의 또 다른 자아를 마주하게 하며, 관람객은 작가와 감정적으로 연결되는 깊은 체험을 하게 됩니다.', '2025-07-10', '2025-07-17'),
('세상의 모든 드로잉', 'UserPoster3.jpg', 0, '반려묘와의 일상에서 비롯된 소소한 행복과 영감을 유쾌하고 따뜻한 드로잉으로 담아낸 전시입니다. 고양이의 시선으로 바라본 세상, 그 안에 담긴 유머와 사랑, 교감의 순간들이 하나하나 정성스레 그려져 있으며, 누구나 공감할 수 있는 감정의 이야기가 펼쳐집니다.', '2025-03-20', '2025-05-27'),
('어반 드로잉', 'UserPoster4.jpg', 0, '도시의 풍경과 그 속에서 살아가는 사람들의 일상을 자유롭고 장난기 넘치는 드로잉으로 풀어낸 전시입니다. 익숙하지만 쉽게 지나쳤던 골목, 버스 정류장, 놀이터, 옥상 위 풍경들이 다시금 따뜻한 기억으로 소환됩니다. 추억과 상상이 맞닿은 공간 속에서 유쾌한 상상을 나누어 보세요.', '2025-01-10', '2025-02-18');
