...
(1, '환 혼', 'poster1.jpg', '이 전시회는 다양한 빛의 표현을 통해 인간 내면의 감정을 섬세하게 그려냅니다. 자연광과 인공조명, 그림자 등 빛의 요소들이 조화롭게 어우러지며, 관람객은 시각적으로 풍부한 자극을 경험하게 됩니다. 각 작품은 빛을 통해 감정의 흐름과 변화, 그리고 내면의 깊이를 탐구하는 여정을 선사합니다.', '2024-05-01', '2024-05-31', 10000, '2024-05-30'),
(2, '감정의 파동', 'poster2.jpg', '감정이라는 추상적인 개념을 색채와 형태로 시각화한 이 전시는, 사랑, 분노, 슬픔, 희망 등 인간의 다양한 감정을 예술로 풀어냅니다. 작가들은 회화, 조각, 미디어 아트 등 다양한 매체를 활용하여 감정의 에너지를 표현하고, 관람객에게 감정의 진폭과 여운을 깊이 있게 전달하고자 합니다.', '2024-06-15', '2024-07-10', 8000, '2024-07-09'),
(3, 'NEW TURN', 'poster3.jpg', '이 전시는 사계절을 주제로 구성된 공간 속에서 시간이 흐르는 방식과 자연의 순환을 체험할 수 있도록 설계되었습니다. 각 계절은 고유한 색감과 정서를 지니며, 그 안에서 느껴지는 시간의 흐름과 감정의 변화는 관람객에게 일상 속에서 놓치기 쉬운 계절의 아름다움을 다시금 일깨워줍니다.', '2025-04-01', '2025-08-30', 12000, '2025-03-31'),
(4, '도시의 단면들', 'poster4.jpg', '현대 도시의 복잡한 양상을 건축물, 거리, 그리고 인간 군상 등을 통해 다층적으로 구성한 전시입니다. 익숙하지만 간과되었던 도시의 풍경과 소외된 공간들을 새로운 시선으로 조명하며, 관람객은 도시가 품고 있는 다양한 삶의 모습과 구조적 이면을 사유하게 됩니다.', '2024-09-10', '2024-10-10', 9000, '2024-10-09'),
(5, '미 로', 'poster5.jpg', '개인의 기억과 집단의 역사를 시각적으로 풀어낸 이 전시는, 과거와 현재, 개인과 사회를 연결하는 매개로서의 예술의 역할을 탐색합니다. 사진, 텍스트, 설치 미술 등이 어우러져 구성된 공간은 관람객 각자의 기억을 되돌아보게 하며, 공감과 회상의 장을 제공합니다.', '2025-11-01', '2025-11-25', 11000, '2025-11-24'),
...
(7, '매혹의 언어', 'poster7.jpg', '전통 정물화에 현대적 생명을 불어넣은 이 전시는 회화와 디지털 기술의 결합을 통해 예술의 경계를 확장합니다. 익숙한 오브제가 새로운 시선으로 재구성되며, 정적인 이미지 속에서 움직임과 내면의 메시지를 읽어낼 수 있는 실험적인 시도가 돋보입니다.', '2025-03-10', '2025-06-05', 10000, '2025-06-04'),
(8, '궁금의 질문들', 'poster8.jpg', '개발과 도시화 속에 사라져가는 공간과 기억들을 예술로 기록한 전시입니다. 회화, 영상, 인터뷰 기록이 함께 어우러져 잊혀진 장소의 흔적을 되살리며, 관람객은 자신이 살아온 공간에 대한 새로운 질문과 감정적 울림을 경험할 수 있습니다.', '2025-01-15', '2025-06-10', 8500, '2025-06-09'),
...
(10, '흑백의 미학', 'poster10.jpg', '모든 작품이 흑백의 명암만으로 구성된 이 전시는 색채 없이도 감정을 표현할 수 있는 예술의 가능성을 보여줍니다. 극적인 명암의 대비와 구성은 고요하면서도 강렬한 인상을 남기며, 색의 부재 속에서도 풍부한 감성을 이끌어내는 작품들이 전시됩니다.', '2024-12-01', '2025-02-26', 9900, '2025-02-25');
...
INSERT INTO reservation (id, user_id, reserve_time_id, reservation_status, created_at, headcount)
VALUES
(1, 'steve12', 1, 'RESERVED', NOW(), 2),
(2, 'steve12', 2, 'RESERVED', NOW(), 2),
(3, 'steve12', 3, 'RESERVED', NOW(), 2),
(4, 'steve12', 4, 'RESERVED', NOW(), 2),
(5, 'steve12', 5, 'RESERVED', NOW(), 2);
